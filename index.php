...
<p class="mb-0">Ultimo controllo eseguito il: <?php // date_default_timezone_set("Europe/Rome"); echo "" . date("d/m/Y") . ", alle ore: "; echo "" . date("h:ia") . ""; ?></p>
 ...
 -->
    ...
    <?php if($fp2 = fsockopen($host2,$port2,$errCode2,$errStr2,$waitTimeoutInSeconds2)){ ?>
      <font style="font-family: 'Nanum Gothic', sans-serif;" color="green"><i class="fas fa-check-circle"></i></i></font>&nbsp;&nbsp;Sito Internet A01/01</font>
      <div style="margin-top: 20px; margin-right: 40%;">
      <div class="alert alert-success" role="alert">
        <p>A seguito dell'ultimo controllo, tutte le infrastrutture sono risultate operative. </p>
        <hr>
    ...
    <?php } else { ?>
      <font style="font-family: 'Nanum Gothic', sans-serif;" color="red"><i class="fas fa-times-circle"></i></font>&nbsp;&nbsp;Sito Internet A01/01</font>
      <div style="margin-top: 20px; margin-right: 40%;">
      <div class="alert alert-danger" role="alert">
        <p>A seguito dell'ultimo controllo, &egrave; risultato un problema ad una infrastruttura. </p>
        <hr>
    ...
    ?>
     ...
     <!-------------->
         ...
         ?>
         <?php if($fp2 = fsockopen($host2,$port2,$errCode2,$errStr2,$waitTimeoutInSeconds2)){ ?>
           <font style="font-family: 'Nanum Gothic', sans-serif;" color="green"><i class="fas fa-check-circle"></i></i></font>&nbsp;&nbsp;Server A04/01</font>
           <div style="margin-top: 20px; margin-right: 40%;">
           <div class="alert alert-success" role="alert">
             <p>A seguito dell'ultimo controllo, tutte le infrastrutture sono risultate operative. </p>
             <hr>
         ...
         <?php } else { ?>
           <font style="font-family: 'Nanum Gothic', sans-serif;" color="red"><i class="fas fa-times-circle"></i></font>&nbsp;&nbsp;Server A04/01</font>
          <div style="margin-top: 20px; margin-right: 40%;">
           <div class="alert alert-danger" role="alert">
             <p>A seguito dell'ultimo controllo, &egrave; risultato un problema ad una infrastruttura. </p>
             <hr>
   ...
   <center>
     <img src="#" width="120" alt="yourdomain.com">
    <div style="margin-top: 25px;">
     <font style="font-family: 'Nanum Gothic', sans-serif;">Il NOC di <a href="https://yourdomain.com">Your website name</a></font>
